...
class AppConfig {
  static Map<NetworkType, AppConfigParams> networks = <NetworkType, AppConfigParams>{
    ...
    NetworkType.Ethereum: AppConfigParams(
      ...
      symbol: 'ETH',
      faucetUrl: 'https://faucet.egorfine.com/',
      transactionsUrl: '',
      enabled: true,
    ...
    NetworkType.BSC: AppConfigParams(
      ...
      transactionsUrl: 'https://testnet.bscscan.com/',
      enabled: true,
