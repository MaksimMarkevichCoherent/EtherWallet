...
class ConfirmMnemonic extends HookWidget {
  const ConfirmMnemonic({Key? key, this.errors, this.onConfirm, this.onGenerateNew}) : super(key: key);
          ...
          child: PaperForm(
            ...
            actionButtons: <Widget>[
              ...
              ElevatedButton(
                ...
                onPressed: onConfirm != null ? () => onConfirm!(mnemonicController.value.text) : null,
              )
            ],
            children: <Widget>[
              Text(
                'Please write down the following words and store them in a safe place as they can\'t be recovered.',
